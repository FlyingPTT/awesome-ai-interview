...
- [RAG Mini System](rag-mini-system/)：本地 Markdown ingestion、sparse/dense/hybrid retrieval、带 citation 的答案和 refusal behavior。
...
- [Coding Agent Mini](coding-agent-mini/)：一个 toy repair loop，会定位 bug、修改代码、运行确定性测试并输出 diff。
...
- Coding Agent 如何把 issue 转成 patch 和可验证结果？
